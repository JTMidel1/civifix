...
const privateRoutes: RouteObject[] = [
  // Complete Profile
  {
    ...
    Component: lazy(() => import('./pages/CompleteProfilePage'))
  },
  // Citizen routes
  {
    path: '/citizen',
    Component: lazy(() => import('./pages/CitizenDashboardPage'))
  },
  {
    path: '/report',
    Component: lazy(() => import('./pages/ReportIssuePage'))
  },
  // Admin routes
  {
    path: '/admin',
  ...
  {
    path: '/admin/issues',
    Component: lazy(() => import('./pages/AdminIssuesPage'))
  },
  // Technician routes
  {
    path: '/technician',
    Component: lazy(() => import('./pages/TechnicianDashboardPage'))
  },
  // Shared routes
  {
    path: '/map',
